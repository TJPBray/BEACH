...
hf = figure ;
disp(['tshow opened figure ',num2str(hf)])
drawnow
hold on
axis equal
axis vis3d
...
set(handles.edit2,'String',num2str(hf))
set(handles.slider1,'Max',nz)
if nz > 1
 set(handles.slider1,'Min',1,'SliderStep',[1/(nz-1) 0.1])
else
...
set(handles.slider1,'Min',1,'SliderStep',[1/(nd-1) 0.1])
