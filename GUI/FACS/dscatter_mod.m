%MODIFIED TO ACCOMMODATE FF AND R2* VALUES
%Tim Bray
...
elseif length(k)>1
    ...
    switch(k)
        ...
        case 3 %'contour'
            [dummy, h] =contour(ctrs1,ctrs2,F,'LineWidth',2,'Fill','on');
            colormap('hot');
        case 4 %'image'
            nc = 256;
            F = F./max(F(:));
