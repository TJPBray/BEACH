function varargout = BEACH_FF(varargin)
...
% Last Modified by GUIDE v2.5 07-Mar-2018 10:16:55
...
%Create column names
Param={'FFmean';'FFmedian';'FF10';'FF25';'FF75';'FF90';'HighFF';'LowFF'};
